...
func (t *bm) generateBMRoute(
	...
	for _, method := range service.Method {
		...
		t.P("		return err")
		t.P("	}")
		t.P(fmt.Sprintf("	data, err := %sMarshaller(resp)", utils.CamelCase(servName)))
		t.P("	if err != nil {")
		t.P("		return err")
		t.P("	}")
		t.P("	c.Set(fiber.HeaderContentType, fiber.MIMEApplicationJSONCharsetUTF8)")
		t.P("	_, err = c.Write(data)")
		t.P("	return err")
		t.P("}")
		t.P()
	}
